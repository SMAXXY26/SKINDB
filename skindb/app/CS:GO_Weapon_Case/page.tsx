                ...
                <div className="flex items-center justify-between mb-12 border-b border-white/10 pb-8">
                    <div>
                        <h1 className="text-5xl font-black italic tracking-tighter uppercase mb-2">
                            CS:GO <span className="text-yellow-500">Weapon Case</span>
                        </h1>
                        <p className="text-gray-400 tracking-widest text-sm uppercase">Original Collection</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                    {data.map((skin) => {
                        ...
                        return (
                            <SkinTile
                                key={skin.id}
                                imageUrl={`/CS:GO_Weapon_Case/${skin.name}.jpeg`}
                                name={skin.name}
                                rarity={skin.rarity}
                                order={order}
                                color={color}
