...
async function CollectionPage() {
    const data = await prisma.skin.findMany({
        where: {
            caseId: 'Bravo', // Ensure this matches your DB ID for Bravo case if it's an ID, or name if logic handles it.
        },
    });
                ...
                <div className="flex items-center justify-between mb-12 border-b border-white/10 pb-8">
                    <div>
                        <h1 className="text-5xl font-black italic tracking-tighter uppercase mb-2">
                            Operation <span className="text-[#8847ff]">Bravo</span>
                        </h1>
